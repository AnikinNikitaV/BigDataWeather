...
class drawer:
    ...
    def draw_graphics_most_frequent_weather(self, city, start_year=1997, end_year=2021, save_dir=None, data_source="files"):
    ...
    def draw_graphic_most_frequent_weather(self, city, start_year=1997, end_year=2021, save_dir=None, data_source="files"):
        weather_combinations = most_frequent_weather(city, start_year=1997, end_year=2021,
                                                    save_dir=None, data_source="files")
    ...
    def draw_graphics_day_night_temperature(self, city, start_year=2020, end_year=2021, save_dir=None, data_source="files"):
    ...
    def draw_graphic_temperatures_compare(self, city, start_year=1999, end_year=2021, save_dir=None, data_source="files"):
        index = 1
